            ...
            VStack {
                ...
                Button(action: {
                    ...
                    if model.onboardingIndex < Constants.screens.count {
                        ...
                        signUpUser(email: model.emailSignUp, password: model.passwordSignUp, name: model.usernameSignUp)
                        BirthOnboardingView()
                    }
                }, label: {
                    if model.onboardingIndex == Constants.screens.count {
...
struct PwdOnboardingView_Previews: PreviewProvider {
